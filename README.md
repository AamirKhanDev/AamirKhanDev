...
| ---------------------------- | ----------------- | --------- | ----------------- |
| [Rat Race](https://github.com/AamirKhanDev/rat_race) | A fun spin on the popular Snakes & Ladders game. Playable on your browser! | 10 days | HTML, CSS, Javascript (React) |
